...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://carefieldc.com/" },
    ...
    links: [{ rel: "canonical", href: "https://carefieldc.com/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://carefieldc.com/",
          logo: "https://carefieldc.com/favicon.ico",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "LocalBusiness",
          name: "مركز مجال العناية للرعاية النهارية",
          image: "https://carefieldc.com/favicon.ico",
          url: "https://carefieldc.com/",
          telephone: "+966560098881",
          address: {
            "@type": "PostalAddress",

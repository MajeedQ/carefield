...
const fields: { key: keyof DbSettings; label: string; type?: "text" | "color" | "checkbox" | "textarea" | "select"; options?: string[]; section: string }[] = [
  ...
  { key: "logo_size" as any, label: "حجم الشعار", type: "select", options: ["sm","md","lg","xl"], section: "الشعار" },
  { key: "logo_shape" as any, label: "شكل الشعار", type: "select", options: ["circle","rounded","square"], section: "الشعار" },
  { key: "logo_show_frame" as any, label: "إظهار الإطار الذهبي الزخرفي حول الشعار", type: "checkbox", section: "الشعار" },

...
const fields: { key: keyof DbSettings; label: string; type?: "text" | "color" | "checkbox" | "textarea" | "select" | "number"; options?: string[]; section: string }[] = [
  ...
  { key: "logo_image_url" as any, label: "رابط صورة الشعار المخصص (اتركه فارغاً لاستخدام الشعار الافتراضي)", section: "الشعار" },
  { key: "logo_size" as any, label: "حجم الشعار الافتراضي", type: "select", options: ["sm","md","lg","xl"], section: "الشعار" },
  { key: "logo_shape" as any, label: "شكل الشعار الافتراضي", type: "select", options: ["circle","rounded","square"], section: "الشعار" },
  { key: "logo_show_frame" as any, label: "إظهار الإطار الذهبي الافتراضي حول الشعار", type: "checkbox", section: "الشعار" },
  { key: "logo_size_mobile" as any, label: "حجم الشعار - الجوال (أقل من 768px)", type: "select", options: ["","sm","md","lg","xl"], section: "الشعار - تخطيطات متعددة" },
  { key: "logo_shape_mobile" as any, label: "شكل الشعار - الجوال", type: "select", options: ["","circle","rounded","square"], section: "الشعار - تخطيطات متعددة" },
  { key: "logo_show_frame_mobile" as any, label: "إظهار الإطار الذهبي - الجوال", type: "checkbox", section: "الشعار - تخطيطات متعددة" },
  { key: "logo_size_tablet" as any, label: "حجم الشعار - التابلت (768px - 1024px)", type: "select", options: ["","sm","md","lg","xl"], section: "الشعار - تخطيطات متعددة" },
  { key: "logo_shape_tablet" as any, label: "شكل الشعار - التابلت", type: "select", options: ["","circle","rounded","square"], section: "الشعار - تخطيطات متعددة" },
  { key: "logo_show_frame_tablet" as any, label: "إظهار الإطار الذهبي - التابلت", type: "checkbox", section: "الشعار - تخطيطات متعددة" },
  { key: "logo_size_desktop" as any, label: "حجم الشعار - الديسكتوب (أكبر من 1024px)", type: "select", options: ["","sm","md","lg","xl"], section: "الشعار - تخطيطات متعددة" },
  { key: "logo_shape_desktop" as any, label: "شكل الشعار - الديسكتوب", type: "select", options: ["","circle","rounded","square"], section: "الشعار - تخطيطات متعددة" },
  { key: "logo_show_frame_desktop" as any, label: "إظهار الإطار الذهبي - الديسكتوب", type: "checkbox", section: "الشعار - تخطيطات متعددة" },
  ...
  { key: "whatsapp_bubble_tag" as any, label: "عنوان البانر المنبثق للواتساب (التاج الصغير)", section: "تواصل" },
  { key: "whatsapp_bubble_text" as any, label: "نص البانر المنبثق للواتساب (الفقرة الترحيبية)", type: "textarea", section: "تواصل" },
  { key: "whatsapp_bubble_cta" as any, label: "نص زر البانر المنبثق للواتساب", section: "تواصل" },

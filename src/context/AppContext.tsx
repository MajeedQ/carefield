  ...
  const config = useMemo<AppConfig>(() => {
    ...
    return {
      ...
      socialMedia: {
        ...
        whatsappBubbleTag: (s as any).whatsapp_bubble_tag ?? "",
        whatsappBubbleText: (s as any).whatsapp_bubble_text ?? "",
        whatsappBubbleCta: (s as any).whatsapp_bubble_cta ?? "",
      ...
      theme: {
        ...
        logoSizeMobile: ((s as any).logo_size_mobile as any) ?? undefined,
        logoSizeTablet: ((s as any).logo_size_tablet as any) ?? undefined,
        logoSizeDesktop: ((s as any).logo_size_desktop as any) ?? undefined,
        logoShapeMobile: ((s as any).logo_shape_mobile as any) ?? undefined,
        logoShapeTablet: ((s as any).logo_shape_tablet as any) ?? undefined,
        logoShapeDesktop: ((s as any).logo_shape_desktop as any) ?? undefined,
        logoShowFrameMobile: (s as any).logo_show_frame_mobile,
        logoShowFrameTablet: (s as any).logo_show_frame_tablet,
        logoShowFrameDesktop: (s as any).logo_show_frame_desktop,
      },
